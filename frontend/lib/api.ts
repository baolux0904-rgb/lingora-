...
// Wave 6 Sprint 5K execute — updateMyUsername + autogenMyUsername
// wrappers removed. Sprint 4.5 commit 1aba1f6 deleted the only caller
// (UsernameBackfillModal.tsx). Backend routes + handlers also dropped
// in this same commit — see authRoutes.js + authController.js.
