  ...
  return (
    <div className="max-w-[600px] mx-auto">
      ...
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
        <div>
          <h2 className="text-lg font-bold" style={{ color: "var(--color-text)" }}>Learning Path</h2>
      ...
      <div className="flex items-center gap-3 mt-8 mb-6">
        ...
        <span className="text-xs font-semibold uppercase tracking-[1.5px] flex items-center gap-2" style={{ color: "rgba(166,179,194,0.5)" }}>
