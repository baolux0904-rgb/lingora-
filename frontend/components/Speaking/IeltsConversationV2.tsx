          ...
          <div className="max-w-2xl mx-auto px-4 py-3">
            ...
            {recorder.errorMessage && (
              <div
                role="alert"
                aria-live="polite"
                className="flex items-start gap-2 mb-2 px-3 py-2 rounded-lg bg-amber-500/10 border border-amber-500/30 animate-fadeIn"
              >
                <svg
                  width="14"
                  height="14"
                ...
                <span className="text-xs text-amber-200 flex-1 leading-relaxed">{recorder.errorMessage}</span>
              </div>
            )}
