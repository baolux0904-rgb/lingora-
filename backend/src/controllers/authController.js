...
// Wave 6 Sprint 5K execute — Sprint 3D patchMyUsername +
// postAutogenUsername handlers removed. They were dead code after
// Sprint 4.5 commit 1aba1f6 deleted UsernameBackfillModal.tsx (the only
// caller). The Sprint 4.5 register form auto-generates usernames at
// /register via the unchanged register() handler above (which calls
// lib/usernameHelper.autogenUsername when the body field is absent).
// VALID_USERNAME_RE import retained — still used by register() validator.
